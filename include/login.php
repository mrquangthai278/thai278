...
<tr>
    ...
    <input type="submit" name ="dangnhap" value="Đăng nhập" class="button" onmouseover="style.background='url(images/button-2-o.gif)'" onmouseout="style.background='url(images/button-o.gif)'" /><br />
    <div style="padding-top:10px; font-family:Tahoma; font-size:12px"> <a href="index.php?b=dk"><strong>[Đăng ký]</strong></a> &nbsp; &nbsp;</div>
    </form>
    </td>
</tr>
</table>
