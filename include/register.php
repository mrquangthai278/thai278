<?php
    ...
    if(isset($_POST["dangky"]))
    {
        ...
        $pass=md5($_POST["pass"]);
        if(isset($act)){
          $thanh_vien = $c_thanh_vien->dang_ky($hoten,$diachi,$email,$dienthoai,$user,$pass);
          echo "<script>alert('Chúc mừng $user! Quý khách đã đăng ký thành công! ');</script>";
          $act=""; $hoten=""; $diachi=""; $email="";$dienthoai="";$user="";
        }      
    }
?>
...
<div align="center">
<form method="post" id="formthanhvien" name="formthanhvien" onSubmit="return thanhvien_insert(user.value,pass.value,apass.value,hoten.value,email.value,diachi.value,dienthoai,anti.value);">
...
<table width="560" cellspacing="0" cellpadding="0" bordercolordark="#FFFFFF" style="border:1px solid #CCC;">
  ...
  <tr bgcolor="#f9f9f9" onmouseover="style.background='#565656'" onmouseout="style.background='#F9F9F9'">  
      ...
      <font color="#FF0000">*</font>
		  <div id="kqkiemtra" style="color:#ff0000;"></div></td>            
  </tr>

  <tr onmouseover="style.background='#565656'" onmouseout="style.background='#FFFFFF'">            
