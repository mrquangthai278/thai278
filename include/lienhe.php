<?php
    ...
    if(isset($_POST['lienhe']))
    {
        ...
        if(isset($act)){
            $lien_he = $c_lien_he->them_lien_he($hoten,$cty,$email,$dienthoai,$fax,$diachi,$noidung,$now);
...
<div align="left"><strong>Quý khách có thể liên hệ với chúng tôi bằng cách soạn thông tin theo mẫu sau. Rất mong những ý kiến đóng góp của quý khách để chúng tôi có thể phục vụ tốt hơn!</strong><br>
